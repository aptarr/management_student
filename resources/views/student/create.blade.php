            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <form action="{{ route('students.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nis" id="nis" required class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div>
                        <label for="nama" class="block text-sm font-medium text-gray-700">Nama</label>
                        <input type="text" name="nama" id="nama" required class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div>
                        <label for="umur" class="block text-sm font-medium text-gray-700">Umur</label>
                        <input type="number" name="umur" id="umur" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div>
                        <label for="kewarganegaraan" class="block text-sm font-medium text-gray-700">Kewarganegaraan</label>
                        <input type="text" name="kewarganegaraan" id="kewarganegaraan" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div>
                        <label for="bahasa" class="block text-sm font-medium text-gray-700">Bahasa</label>
                        <input type="text" name="bahasa" id="bahasa" class="mt-1 w-full border-gray-300 rounded-md shadow-sm" placeholder="Contoh: Indonesia, Inggris">
                    </div>

                    <div>
                        <label for="domisili" class="block text-sm font-medium text-gray-700">Domisili</label>
                        <input type="text" name="domisili" id="domisili" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div>
                        <label for="nomor" class="block text-sm font-medium text-gray-700">Nomor HP</label>
                        <input type="text" name="nomor" id="nomor" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                        <input type="email" name="email" id="email" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div>
                        <label for="hobi" class="block text-sm font-medium text-gray-700">Hobi</label>
                        <input type="text" name="hobi" id="hobi" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div>
                        <label for="tinggi_badan" class="block text-sm font-medium text-gray-700">Tinggi Badan (cm)</label>
                        <input type="number" name="tinggi_badan" id="tinggi_badan" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div>
                        <label for="berat_badan" class="block text-sm font-medium text-gray-700">Berat Badan (kg)</label>
                        <input type="number" name="berat_badan" id="berat_badan" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div>
                        <label for="ukuran_sepatu" class="block text-sm font-medium text-gray-700">Ukuran Sepatu</label>
                        <input type="number" name="ukuran_sepatu" id="ukuran_sepatu" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div>
                        <label for="agama" class="block text-sm font-medium text-gray-700">Agama</label>
                        <input type="text" name="agama" id="agama" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="kelebihan" id="kelebihan" rows="3" class="mt-1 w-full border-gray-300 rounded-md shadow-sm"></textarea>
                    </div>

                    <div class="md:col-span-2">
                        <label for="kekurangan" class="block text-sm font-medium text-gray-700">Kekurangan</label>
                        <textarea name="kekurangan" id="kekurangan" rows="3" class="mt-1 w-full border-gray-300 rounded-md shadow-sm"></textarea>
                    </div>

                    <div class="md:col-span-2">
                        <label for="promosi" class="block text-sm font-medium text-gray-700">Promosi Diri</label>
                        <textarea name="promosi" id="promosi" rows="3" class="mt-1 w-full border-gray-300 rounded-md shadow-sm"></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="keterangan_tinggal_jp" id="keterangan_tinggal_jp" rows="2" class="mt-1 w-full border-gray-300 rounded-md shadow-sm"></textarea>
                    </div>
