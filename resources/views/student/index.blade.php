<x-app-layout>
    ...
    <div class="py-6 mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-end mb-4 space-x-4">
            <a href="{{ route('students.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-1 px-4 rounded text-xl flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3z"/>
                </svg>
                <span>Add Student</span>
            </a>
            <a href="{{ route('students.export') }}" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-1 px-4 rounded text-xl flex items-center space-x-2">
        ...
        <form id="searchForm" method="GET" action="{{ route('students.index') }}">     
            <div class="justify-end mb-4 hidden">                
                <button type="submit" form="searchForm" class="bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded text-sm">
                        Filter
                </button>
            </div>
                ...
                <table class="table-auto w-full mt-5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2 items-center space-y-2">
                                <a href="{{ route('students.detail', $student->id) }}" class="bg-yellow-400 hover:bg-yellow-500 text-white font-semibold py-1 px-3 rounded text-sm">
                                    Edit
                                </a>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('input[form="searchForm"]').forEach(input => {
            input.addEventListener('keydown', function (e) {
                if (e.key === 'Enter') {
                    e.preventDefault(); // prevent default form submission inside table
